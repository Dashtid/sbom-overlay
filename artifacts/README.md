...
2.3 tag-value content. Cover everything a scanner can't see: vendored
binaries, statically linked libraries, runtime-loaded plugins,
proprietary natives. The repo's existing dogfood fixture
